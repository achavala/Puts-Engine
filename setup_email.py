...
def main():
    print("=" * 60)
    print("🏛️ PUTSENGINE EMAIL SETUP")
    print("=" * 60)
    print()
    ...
    if not all([sender, password, recipient]):
        print()
        print("❌ Missing required fields. Please provide all values.")
        return
    
    # Save to .env file
    env_content = f"""# PutsEngine Email Configuration
...
"""
    ...
    if test == "y":
        ...
        try:
            ...
            if success:
                ...
                print()
                print("❌ Email failed. Check your App Password and Gmail settings.")
    ...
    print("=" * 60)
    print()
    print("📧 Daily reports will be sent at 3 PM EST")
    print()
